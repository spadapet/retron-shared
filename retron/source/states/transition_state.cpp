    ...
    , offset_stop(static_cast<int>(vertical_pixel_stop))
{
    ...
    this->target = ff::dxgi_client().create_target_for_texture(this->texture->dxgi_texture(), 0, 0, 0);
    this->target2 = ff::dxgi_client().create_target_for_texture(this->texture2->dxgi_texture(), 0, 0, 0);
}
...
{
    this->target->clear(ff::dxgi_client().frame_context(), ff::dxgi::color_black());
    this->target2->clear(ff::dxgi_client().frame_context(), ff::dxgi::color_black());
